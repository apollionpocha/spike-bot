module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('sk_pack' in setting)) setting.sk_pack = 'kysage'
      ...
      if (!('owners' in setting)) setting.owners = ['254769918110']
      if (!isNumber(setting.lastReset)) setting.lastReset = new Date * 1
      if (!('msg' in setting)) setting.msg = 'Hi +tag 🪸\nI am *Spike*.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version.'
      if (!isNumber(setting.style)) setting.style = 4
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/22390e3c88a52f3237fc7.jpg'
      if (!('link' in setting)) setting.link = 'https://wa.me/254769918110'
   } else {
      global.db.setting = {
         autodownload: true,
         debug: false,
         ...
         msg: 'Hi +tag 🪸\nI am *Spike*\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version.',
         style: 4,
         cover: 'https://telegra.ph/file/22390e3c88a52f3237fc7.jpg',
         link: 'https://wa.me/254769918110'
      }
   }
}